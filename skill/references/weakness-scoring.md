...
Review count increments once per page per session log. If the user
logs multiple sessions in a day, each log counts separately (e.g.
morning and evening sessions = 2 reviews).
